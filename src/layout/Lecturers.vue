                ...
                <div class="lecturer-inner">
                    ...
                    <div class="lecturer-description">
                        <div class="lecturer-organization">
                            ...
                            <div>
                                クリエイティブを用いて課題を解決する、トータルプランニングカンパニーです。広告製作を始め、ブランドやデジタルプロダクトの開発、アーティストのマネジメントなど、クリエイティブを土台とした様々な事業を、総合的に企画・制作しています。
                                螺旋(Helix)のような常に上昇し続ける向上心を持ちながら、クライアントや世の中をもっと先へ進めることのできる事業を創出していくことを理念としています。
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="lecturer-description">
                        <div class="lecturer-organization">
                            ...
                            <div>
                                ...
                                <p>
                                    そのことだけを考えて、そのために最大限の努力をして最大限の力を発揮する。<br>
                                    そのシンプルな"答え"に本気で立ち向かっています。<br>
                                    たくさんの"面白い"をエンターテインメントとして"世界"へ向けて発信していきます。
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="lecturer-inner">
                    ...
                    <div class="lecturer-description">
                        <div class="lecturer-organization">
                            ...
                            <div>
                                映像・動画/3DCG・イラスト/音楽/ナレーション、様々なプロフェッショナルが集い、デジタルコンテンツをオールジャンルで手がける総合制作会社です。
                                的確に消費者ニーズを捉え、インターネットとリアルの両側から、質の高いサービスを提供することに力を注いでおり、品質・価格・迅速な対応等、全てのサービスにクオリティーを追求していく「姿勢」を大事にしています。
                            </div>
                        </div>
                    </div>
                </div>
